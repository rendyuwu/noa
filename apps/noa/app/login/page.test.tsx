...
describe("LoginPage", () => {
  ...
  it("shows pending approval copy from error_code instead of backend detail prose", async () => {
    ...
    expect(alert).toHaveTextContent("Your account is pending approval. Ask an admin to enable it.");
    expect(alert).not.toHaveTextContent("Approval request is still awaiting administrator review.");
  });

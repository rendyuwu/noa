            ...
            <div className="space-y-4">
              ...
              <dl className="grid gap-3 text-sm">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <dd className="text-right text-text">{selectedServer.api_token_id}</dd>
                </div>
                <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  <dt className="text-muted">Token secret</dt>
                  <dd className="text-right text-text">{selectedServer.has_api_token_secret ? "configured" : "missing"}</dd>
                </div>
                <div className="flex items-start justify-between gap-4">

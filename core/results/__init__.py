"""Large READ results, parked off the transcript.

One module today, `tables`. A READ whose answer is a listing rather than a fact — WHM's
accounts, PMG's mynetworks — writes the body here and answers the model with a
...
the cap's own bound, total and truncation flag beside it.

...
compares `expires_at <= decided_at` when an operator reaches a stale card, and the expiry loop's
sweep
...
The table surface added a fourth reader outside this package — it refuses a parked table
